...
| Linux | the calling thread's `mountinfo` | the calling thread's `mountinfo` | sysfs `removable` and a USB/MMC ancestry, down `slaves/`; nothing denies | `/dev/disk/by-label` reverse lookup |
